...
```text
GET https://api.nebulaecn.com/v1/account/stats/pnl
```
...
```text
GET https://api.nebulaecn.com/v1/account/transactions
```
...
```text
POST https://api.nebulaecn.com/v1/account/withdraws
```
...
```text
GET https://api.nebulaecn.com/v1/account/withdraws
```
...
```text
GET https://api.nebulaecn.com/v1/account/withdraws/sums
```
...
```text
DELETE https://api.nebulaecn.com/v1/account/beneficiaries/{id}
```
...
```text
GET https://api.nebulaecn.com/v1/account/beneficiaries/{id}
```
...
```text
PATCH https://api.nebulaecn.com/v1/account/beneficiaries/{id}/activate
```
...
```text
PATCH https://api.nebulaecn.com/v1/account/beneficiaries/{id}/resend_pin
```
...
```text
POST https://api.nebulaecn.com/v1/account/beneficiaries
```
...
```text
GET https://api.nebulaecn.com/v1/account/beneficiaries
```
...
```text
GET https://api.nebulaecn.com/v1/account/deposit_address/{currency}
```
...
```text
GET https://api.nebulaecn.com/v1/account/deposits/{txid}
```
...
```text
GET https://api.nebulaecn.com/v1/account/deposits
```
...
```text
GET https://api.nebulaecn.com/v1/account/balances/{currency}
```
...
```text
GET https://api.nebulaecn.com/v1/account/balances/
```
