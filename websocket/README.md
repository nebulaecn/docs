...
1. **Сначала, получите cookie используя REST метод авторизации**
...
**Используйте полученную куку для подключения к приватным сокетам, например**
...
{"success":{"message":"subscribed","streams":\["balances","order","trade"\]}}

а не то что ниже, замени
